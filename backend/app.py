...
def get_events():
    events = [
        ...
        {"id": 2, "type": "Tackle", "descriptor": "Player 3", "duration": 3, "time": 18, "result": "Failure", "x": 13, "y": 8},
        ...
        {"id": 5, "type": "Tackle", "descriptor": "Player 3", "duration": 3, "time": 30, "result": "Success", "x": 55, "y": 25},
        {"id": 6, "type": "Tackle", "descriptor": "Player 2", "duration": 3, "time": 37, "result": "Success", "x": 57, "y": 28},
