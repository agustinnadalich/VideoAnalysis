...
# VERSION VIEJA DE LA FUNCION DESDE EXCEL QUE FUNCIONABA Y DE DONDE HEMOS PERDIDO COSAS
def normalize_excel_to_json_OLD(filepath, profile, discard_categories=None):
    """Normaliza archivo Excel a formato JSON"""
    # Validar archivo
    if not os.path.exists(filepath):
        print(f"❌ El archivo {filepath} no existe.")
